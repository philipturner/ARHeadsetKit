...
Xcode 13.1 or higher is required for working with ARHeadsetKit, and an iOS device running at least iOS 14.0. You DO NOT need Google Cardboard. To get started, follow [this guide](docs/building-documentation.md) on how to use ARHeadsetKit's tutorials.
...
- [ ] Ch. 2 - Interactive Experiences
  ...
  - [x] Tutorial 6 - Physics-Based Interaction (complete)
  - [ ] Tutorial 7 - Using Delegate Renderers (in progress)
